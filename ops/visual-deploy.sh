...
[[ -f $release/VISUAL_UPDATE.md && -f $release/backend/prisma/migrations/202609150003_managed_requests/migration.sql ]] || fail 'В GitHub ещё нет обновления визуала и заявок.'
