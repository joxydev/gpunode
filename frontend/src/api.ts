...
export type RequestItem={id:string;nodeId:string;profile:string;workload:string;paymentStatus:'WAITING'|'PAID';status:string;decision?:string|null;closureReason?:string|null;closedAt?:string|null;createdAt:string;updatedAt:string;equipment?:{id:string;name:string};user?:{id:string;name:string;username?:string|null}};
